...
export const AddressGrid: React.FC<AddressesProps> = ({
  ...
  useEffect(() => {
    ...
    console.log("UseEffect addresses length===>"+addresses?.length);
  ...
  function onAdd(address: any) {
    openModal('ADD_OR_UPDATE_ADDRESS', { customerId: userId, type,atom });
  }
  function onEdit(address: any) {
    openModal('ADD_OR_UPDATE_ADDRESS', { customerId: userId, address,atom });
  }
